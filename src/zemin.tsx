      ...
      map.current.addLayer({
        ...
        paint: {
          "fill-color": [
            ...
            ["==", ["get", "name"], "Kireçtaşı"],
            "#ffff00",
            ["==", ["get", "name"], "Gevşek Dolgu"],
            "#903373",
            ["==", ["get", "name"], "Sağlam Kaya"],
            "#888888",
            ["==", ["get", "name"], "Yumuşak Toprak"],
            "#325928",
            ["==", ["get", "name"], "Çakıllı Toprak"],
            "#191e28",
            ["==", ["get", "name"], "Kumlu Toprak"],
            "#00387b",
            ["==", ["get", "name"], "Killi Toprak"],
            "#FFB347",
